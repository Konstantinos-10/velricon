            ...
            <div className="relative">
              ...
              <div className="md:pl-8 xl:pl-12">
                ...
                >
                  ...
                  <span className="block mt-2">that helps businesses grow with confidence</span>
                </motion.h1>
                ...
                >
                  Three focused ways we support your business through key financial moments — financing, investment readiness, and clarity for decisions that matter.
                </motion.p>
                ...
                >
                  Strategic. Structured. Built for decisions.
                </motion.p>
                ...
                >
                  <button
                    ...
                    className="inline-flex items-center gap-2 text-lg font-body text-platinum/70 hover:text-white transition-colors duration-200 tracking-wide group"
                  >
